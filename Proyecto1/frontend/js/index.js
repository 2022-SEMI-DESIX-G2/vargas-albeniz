((utils) => {
    const App = {
        htmlElements: {
            ...
            pokemonOutput: document.querySelector("#pokemon-ouput"),
            viewSprites: document.querySelector("#view-sprites"),
            viewEvoChain: document.querySelector("#view-evochain"),
            viewLocation: document.querySelector("#view-location"),
            errorMessage: document.querySelector("#error-message"),
        },
        init: () => {
            App.htmlElements.pokemonForm.addEventListener("submit",App.handlers.handleFormSubmit);
        },
        handlers: {
            handleFormSubmit: async(e) => {
                ...
                const checkSprites = App.htmlElements.viewSprites.checked;
                const checkLocation = App.htmlElements.viewLocation.checked;
                const checkEvoChain = App.htmlElements.viewEvoChain.checked;

                App.htmlElements.errorMessage.innerHTML = "";
                ...
                try {
                    if (!pokemon){
                        App.htmlElements.errorMessage.innerHTML = "Introduzca un Pokemon a buscar";
                    } else {
                    ...
                    App.htmlElements.errorMessage.innerHTML = `<h1>${error}</h1>`;
                }
